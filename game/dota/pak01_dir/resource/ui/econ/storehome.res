"Resource/UI/StoreHome.res"
{
	...
	"SaxtonBackgroundPanel"
	{
		...
		"MannCoImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"materials/vgui/store/store_mannco_logo.vmat"
			"scaleImage"	"1"
		}
		"SaxtonImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"materials/vgui/store/store_saxton_thumbs_up.vmat"
			"scaleImage"	"1"
		}
	}
	...
	"FeaturedItemSymbol"
	{
		...
		"visible"		"1"
		"enabled"		"1"
		"image"			"materials/vgui/store/store_starburst.vmat"
		"scaleImage"	"1"
	}
	...
	"TextContainerPanel"
	{
		...
		"BGImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"materials/vgui/store/store_home_background.vmat"
			"scaleImage"	"1"
		}
		...
		"SaxtonSignatureImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"materials/vgui/store/store_saxton_signature.vmat"
			"scaleImage"	"1"
		}
		...
		"PromotionImage_BonusItem"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"materials/vgui/store/store_surprise.vmat"
			"scaleImage"	"1"
		}
		...
		"PromotionImage_Hat"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"materials/vgui/backpack/player/items/all_class/all_manncap_large.vmat"
			"scaleImage"	"1"
		}
