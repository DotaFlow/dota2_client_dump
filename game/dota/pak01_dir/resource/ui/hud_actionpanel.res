...
//
	...
	"AbilityHotkeyPanel_4" { ControlName=CDOTAHotkeyPanel fieldName=AbilityHotkeyPanel_4 zpos=10 wide=0 tall=0 OffsetX=-10 OffsetY=-10 mouseInputEnabled=0 }
...
//
	...
	Layout
	{
		...
		Place { Region=AbilityRegion x=4 y=24 Margin-Left=14 Spacing=36 Controls=AbilityButton_0,AbilityButton_1,AbilityButton_2,AbilityButton_3 }
		...
		Place { Region=FooterRegion x=4 y=2 Margin-left=14 spacing=36 Controls=AbilityLevel_0,AbilityLevel_1,AbilityLevel_2,AbilityLevel_3 }
		Place { Region=FooterRegion x=4 Margin-Left=14 Spacing=36 Controls=AbilityLearn_0,AbilityLearn_1,AbilityLearn_2,AbilityLearn_3 }
