...
//
	...
	"AbilityHotkeyPanel_5" { ControlName=CDOTAHotkeyPanel fieldName=AbilityHotkeyPanel_5 zpos=10 wide=0 tall=0 OffsetX=-10 OffsetY=-10 mouseInputEnabled=0 }
...
//
	...
	Layout
	{
		...
		Place { Region=AbilityRegion x=4 y=24 Margin-Left=10 Spacing=10 Controls=AbilityButton_0,AbilityButton_1,AbilityButton_2,AbilityButton_3,AbilityButton_4 }
		
		Place { Region=AbilityRegion margin-left=-83 margin-top=-3 start=AbilityButton_0 Controls=AbilityBezel_0 }
		Place { Region=AbilityRegion margin-left=-83 margin-top=-3 start=AbilityButton_1 Controls=AbilityBezel_1 }
		Place { Region=AbilityRegion margin-left=-83 margin-top=-3 start=AbilityButton_2 Controls=AbilityBezel_2 }
		Place { Region=AbilityRegion margin-left=-83 margin-top=-3 start=AbilityButton_3 Controls=AbilityBezel_3 }
		Place { Region=AbilityRegion margin-left=-83 margin-top=-3 start=AbilityButton_4 Controls=AbilityBezel_4 }
		
		Region { name=FooterRegion x=172 y=144 width=465 height=60 }
		Place { Region=FooterRegion x=4 y=2 Margin-left=10 spacing=10 Controls=AbilityLevel_0,AbilityLevel_1,AbilityLevel_2,AbilityLevel_3,AbilityLevel_4 }
		Place { Region=FooterRegion x=4 Margin-Left=10 Spacing=10 Controls=AbilityLearn_0,AbilityLearn_1,AbilityLearn_2,AbilityLearn_3,AbilityLearn_4 }
