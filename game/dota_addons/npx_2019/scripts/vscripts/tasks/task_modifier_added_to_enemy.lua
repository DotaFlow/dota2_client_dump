...
if CDotaNPXTask_Modifier_Added_To_Enemy == nil then
	CDotaNPXTask_Modifier_Added_To_Enemy = class( {}, {}, CDotaNPXTask )
end

----------------------------------------------------------------------------

function CDotaNPXTask_Modifier_Added_To_Enemy:RegisterTaskEvent()
...
function CDotaNPXTask_Modifier_Added_To_Enemy:OnQueryProgressChanged( nQueryID, nProgress )
...
function CDotaNPXTask_Modifier_Added_To_Enemy:OnQuerySucceeded( nQueryID )
	self:CompleteTask()
end

----------------------------------------------------------------------------

function CDotaNPXTask_Modifier_Added_To_Enemy:GetQueryID()
	return self.nTaskListener
end

----------------------------------------------------------------------------

function CDotaNPXTask_Modifier_Added_To_Enemy:UnregisterTaskEvent()
...
return CDotaNPXTask_Modifier_Added_To_Enemy