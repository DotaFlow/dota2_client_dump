...
function CHeroDemo:InitGameMode()
	...
	ListenToGameEvent( "game_rules_shutdown", Dynamic_Wrap( CHeroDemo, "OnGameShutdown" ), self )
...
-- OnMapShutDown
--------------------------------------------------------------------------------
function CHeroDemo:OnGameShutdown()
	SendToServerConsole( "r_hero_debug_render_mode 0" )
end
